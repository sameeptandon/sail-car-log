...
int main(int argc, char** arv)
{
    ...
    for (int k = start; k < end; k += step)
    {
        ...
        for (int w = 0; w < current_clouds.size(); w++)
        {
            ...
            // TODO Could just do all of these transforms to all the clouds
            // beforehand to speed things up later
            ...
            filter_lidar_cloud(pcloud, final_cloud, filtered_indices, params().lidar_project_min_dist);
