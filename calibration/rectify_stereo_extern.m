...
if ~isempty(calib_name_left)&~isempty(calib_name_right),
    ...
    for kk = find(active_images);
        ...
        I = load_png_image(kk,calib_name_left,format_image_left,type_numbering_left,image_numbers_left,N_slots_left);
        ...
        write_png_image(I2,kk,[calib_name_left '_rectified'],format_image_left,type_numbering_left,image_numbers_left,N_slots_left ),
        
        fprintf(1,'\n');
        
        % Right image:
        
        I = load_png_image(kk,calib_name_right,format_image_right,type_numbering_right,image_numbers_right,N_slots_right);
        ...
        write_png_image(I2,kk,[calib_name_right '_rectified'],format_image_right,type_numbering_right,image_numbers_right,N_slots_right );
