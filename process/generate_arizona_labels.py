...
def findLanesConvolution(img, origSize=(960,1280), lastCols=[None, None], lastLine=[None,None,None,None]):
...
"""
    ...
    if True:#LEFT_LANE_DETECTION:
        left_lane_min_x = lastCols[0]-max_lane_size/2;
        left_lane_max_x = lastCols[0]+max_lane_size/2;
    #else:
    #    left_lane_min_x = midpoint_lastCols
    #    left_lane_max_x = midpoint_lastCols
    if True:#RIGHT_LANE_DETECTION:
        right_lane_min_x = lastCols[1]-max_lane_size/2;
        right_lane_max_x = lastCols[1]+max_lane_size/2;
    #else:
